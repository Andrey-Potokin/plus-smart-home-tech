...
public class ErrorHandler {
    ...
    public ResponseEntity<ApiError> handleNotFoundException(Exception ex) {
        ...
        String customMessage = switch (ex) {
            case NotFoundException e -> "Ресурс не найден. Пожалуйста, проверьте запрос.";
            case NoOrderFoundException e -> "Заказ не найден. Пожалуйста, проверьте запрос.";
            case ProductNotFoundException e -> "Товар не найден. Пожалуйста, проверьте запрос.";
